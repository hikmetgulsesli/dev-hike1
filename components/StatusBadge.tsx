...
export function StatusBadge({ text, available = true }: StatusBadgeProps) {
  return (
    <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-surface-container border border-outline/20">
      <span className="relative flex h-2.5 w-2.5">
        ...
        {!available && (
          <span className="relative inline-flex rounded-full h-2.5 w-2.5 bg-text-muted" />
        )}
      </span>
